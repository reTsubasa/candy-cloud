...
const eventLabels: Record<string, { title: string; detail: string }> = {
  ...
  RUNTIME_CONFIGURATION_PREPARED: { title: '节点配置已准备', detail: '候选配置已完成校验和落盘，节点继续使用当前配置并等待全网统一提交。' },
  RUNTIME_CONFIGURATION_ACTIVATED: { title: '节点配置已激活', detail: '节点已热加载并接管本批次配置。' },
