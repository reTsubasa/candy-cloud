...
describe('runtime error display', () => {
  ...
  it('covers every error emitted by Core, the SD-WAN agent, Cloud sync and netd', () => {
    const emittedCodes = [
      ...
      'netd_reconfigure_ipc_failed', 'netd_reconfigure_peer_closed', 'netd_reconfigure_owner_conflict', 'peer_stream_closed', 'peer_stream_read_failed', 'peer_stream_write_failed',
