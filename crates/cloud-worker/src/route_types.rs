...
pub const ROUTE_PUBLICATION_VALIDITY_SECONDS: u64 = 24 * 60 * 60;
pub const ROUTE_PUBLICATION_STALE_SECONDS: u64 = 48 * 60 * 60;
pub const MAXIMUM_ROLLING_ACTIVATION_SECONDS: u64 = 10 * 60;
pub const PUBLICATION_SCHEDULING_MARGIN_SECONDS: u64 = 5 * 60;
pub const PUBLICATION_REFRESH_LEAD_SECONDS: u64 =
    MAXIMUM_ROLLING_ACTIVATION_SECONDS + PUBLICATION_SCHEDULING_MARGIN_SECONDS;

const _: () = assert!(ROUTE_PUBLICATION_VALIDITY_SECONDS > PUBLICATION_REFRESH_LEAD_SECONDS);
const _: () = assert!(ROUTE_PUBLICATION_STALE_SECONDS > ROUTE_PUBLICATION_VALIDITY_SECONDS);
