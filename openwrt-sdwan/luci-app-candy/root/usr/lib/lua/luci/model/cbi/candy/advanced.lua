...
m = Map("candy", translate("Advanced"), translate("Expert DNS, provider, and transparent proxy controls. Candy negotiates transport performance automatically."))
...
s.description = translate("Advanced transparent proxy controls for LAN UDP/443 and QUIC behavior.")
s.addremove = false
s.anonymous = true
