...
- Candy Core Cloud ABI profile: `0.3.51` from the unified signed release
  `core-v0.3.51`
- wire line: `0.3`
...
The project consumes the signed Candy Core Cloud ABI profile `0.3.51` from
the unified `core-v0.3.51` release and wire line `0.3`. The source revision is
...
same signed `core-v0.3.51` Cloud ABI release. It runs automatically for
