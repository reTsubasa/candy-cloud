...
- Candy Core Cloud ABI profile: `0.3.54` from the unified signed release
  `core-v0.3.54`
- wire line: `0.3`
...
The project consumes the signed Candy Core Cloud ABI profile `0.3.54` from
the unified `core-v0.3.54` release and wire line `0.3`. The source revision is
...
same signed `core-v0.3.54` Cloud ABI release. It runs automatically for
